...
const [data,setData]=useState([])
  ...
  const getAllData=async()=>{
    ...
    const res= await axios.post('http://localhost:5000/bollywood')
 ...
 useEffect(()=>{
  ...
  return (
    <>
            <h1 style={{ marginLeft: '30px', padding: '20px',color:'aqua',fontSize:'40px' }}>Bollywood</h1>
      <div className='tourism'>
        ...
        <div className='side-bar'>
          <h1 style={{ padding: '20px',color:'aqua',fontSize:'40px' }}>Top Post</h1>
          {
            data.map((e) =>
              <>
